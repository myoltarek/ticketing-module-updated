...
@section('content')
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0 text-dark">Division Panel</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                ...
                                @foreach($divisions as $division)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ url('/division', ['id' => $division->id]) }}" method="post" style ='float: left; padding: 5px;'>
                                                @method('delete')
                                                @csrf
                                                <button type="submit" class="btn btn-danger delete-confirm" data-name="{{ $division->name }}"><i class="fa fa-trash-alt"></i></button> 
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
