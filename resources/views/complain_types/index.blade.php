            ...
            <div class="row">
                <div class="col">
                    <div class="card text-center">
                        ...
                        <div class="col-md-10">
                            <h3 class="card-title">Complain Type List</h3>
                        </div>
                        <div class="col-md-2 float-right">
                            <form action="{{ url('/complain-type/create') }}" method="GET">
                                ...
                                @foreach($complain_types as $complain_type)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ url('/complain-type', ['id' => $complain_type->id]) }}" method="post" style ='float: left; padding: 5px;'>
                                                @method('delete')
                                                @csrf
                                                <button type="submit" class="btn btn-danger delete-confirm" data-name="{{ $complain_type->name }}"><i class="fa fa-trash-alt"></i></button> 
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
